...
function showScene() {
    ...
    if (currentState === "start") {
        ...
        endingMessage.textContent = "You approach the guy and talk a deal in splitting 50/50 profits in a prohibition lab to sell millions of pounds of illicit seaweed (AS FISH). In symbiosis you both build a seaweed empire in the Caribbean (NOT REAL).";
...
function replaceImage(imageId, newSrc) {
...
function setButtonAction(buttonId, newText, action) {
...
function checkPassword(inputId, correctPassword) {
    ...
    if (input && input.value === correctPassword) {
        alert("Password correct! The safe opens.");
        return true;
    } else {
...
document.getElementById("button1").addEventListener("mouseover", () => {
    console.log("Mouse over Button 1");
});
document.getElementById("button2").addEventListener("mouseover", () => {
    console.log("Mouse over Button 2");
});
document.getElementById("button3").addEventListener("mouseover", () => {
    console.log("Mouse over Button 3");
});
document.getElementById("button4").addEventListener("mouseover", () => {
    console.log("Mouse over Button 4");
});

document.getElementById("button1").addEventListener("dblclick", () => {
    alert("Button 1 double clicked");
});
document.getElementById("button2").addEventListener("dblclick", () => {
    alert("Button 2 double clicked");
});
document.getElementById("button3").addEventListener("dblclick", () => {
    alert("Button 3 double clicked");
});
document.getElementById("button4").addEventListener("dblclick", () => {
